// src/app/[locale]/aboutus/page.js
'use client';
  ...
  const teamData = [
    {
      ...
      name: t('team.calvinCarlo.name') || 'Calvin Carlo',
      title: t('team.calvinCarlo.title') || 'C.E.O',
    },
    {
      image: '/images/client/02.jpg',
      name: t('team.alianaRosy.name') || 'Aliana Rosy',
      title: t('team.alianaRosy.title') || 'Co-founder',
    },
    {
      image: '/images/client/03.jpg',
      name: t('team.sofiaRazaq.name') || 'Sofia Razaq',
      title: t('team.sofiaRazaq.title') || 'C.O.O.',
    },
    {
      image: '/images/client/04.jpg',
      name: t('team.ronnyJofra.name') || 'Ronny Jofra',
      title: t('team.ronnyJofra.title') || 'Director',
    },
    {
      image: '/images/client/05.jpg',
      name: t('team.cristinaMurphy.name') || 'Cristina Murphy',
      title: t('team.cristinaMurphy.title') || 'Manager',
    },
    {
      image: '/images/client/06.jpg',
      name: t('team.jimmiShaa.name') || 'Jimmi Shaa',
      title: t('team.jimmiShaa.title') || 'Operator',
    },
  ];
          ...
          <div className="grid grid-cols-1 text-center mt-6">
            ...
            <ul className="tracking-[0.5px] mb-0 inline-block mt-5">
              <li className="inline-block capitalize text-[15px] font-medium duration-500 ease-in-out text-white/50 hover:text-white">
                <Link href={`/${locale}`}>Mortal.Ai</Link>
              </li>
      ...
      <section className="relative md:py-24 py-16">
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
            ...
            <div className="">
              <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">
                <span className="font-bold">{t('workSmarter')}</span> <br /> {t('byUsingAI')}
              </h3>
              ...
              <div className="mt-4">
                <Link href={`/${locale}/contact`} className="hover:text-amber-400 font-medium duration-500">
                  {t('readMore')} <i className="mdi mdi-chevron-right text-[20px] align-middle"></i>
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="lg:w-4/5">
              <ul className="md:flex inline-block w-fit mx-auto flex-wrap justify-center text-center p-2 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                  ...
                  >
                    <h5 className="text-base font-semibold">{t('tabs.dragAndDrop.title')}</h5>
                    <p className="text-sm mt-1">{t('tabs.dragAndDrop.description')}</p>
                  </button>
                </li>
                <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                  <button
                  ...
                  >
                    <h5 className="text-base font-semibold">{t('tabs.improveTalent.title')}</h5>
                    <p className="text-sm mt-1">{t('tabs.improveTalent.description')}</p>
                  </button>
                </li>
                <li role="presentation" className="inline-block md:w-1/3 w-full p-2">
                  <button
                  ...
                  >
                    <h5 className="text-base font-semibold">{t('tabs.goLive.title')}</h5>
                    <p className="text-sm mt-1">{t('tabs.goLive.description')}</p>
                  </button>
                </li>
              </ul>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 pb-6 text-center">
            <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">{t('team.title')}</h3>
            <p className="text-slate-400 max-w-xl mx-auto">{t('team.description')}</p>
          </div>
            ...
            {teamData.map((item, index) => (
              ...
              >
                ...
                <div className="min-w-0 py-10 ps-36 pe-6">
                  <Link href={`/${locale}/team`} className="text-lg font-medium hover:text-amber-400">
                    {item.name}
                  </Link>
